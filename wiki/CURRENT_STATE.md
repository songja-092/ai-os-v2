...
2026-08-21 PM4는 로컬 우선 Collector 최소 Pilot으로 시작했습니다. 기존 성공 자산이 충분하면 외부 조사를 생략하고, 부족하면 필요한 근거만 조사 요청으로 만드는 두 분기를 Network 없이 `7/7 PASS`했습니다. 이는 PM4 전체 PASS가 아닙니다. 실제 조사 요청, 출처 검증, 사용자 `채택·보류·폐기`, 채택 후 Capability Lab 연결은 아직 `not_yet_verified`입니다. 자세한 증거는 [[PM4_LOCAL_FIRST_COLLECTOR_PILOT_2026-08-21]]을 사용합니다.
